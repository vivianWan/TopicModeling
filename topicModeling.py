# -*- coding: utf-8 -*-
"""
Created on Thu Nov 29 12:15:47 2018
modified from medium.com/mlreview/topic-modeling -with-scikit-learn
...
# Run NMF
nmf = NMF(n_components=no_topics, random_state=1, alpha=1, l1_ratio=0.5, init='nndsvd').fit(tfidf)
...
display_topics(lad, tf_feature_names, no_top_words)
